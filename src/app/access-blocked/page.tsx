    ...
    >
      <div className="w-full max-w-md text-center">
        ...
        <div
          ...
          style={{ borderColor: "rgba(107,33,168,0.15)" }}
        >
          <div
          ...
          <p className="text-sm leading-relaxed mb-6" style={{ color: "rgba(26,26,26,0.6)" }}>
            Your access to the MRCPI OBGYN Unlocked platform has been temporarily suspended. You are currently unable to log in or access any course materials.
          </p>
          ...
          >
            ...
            <p className="text-xs leading-relaxed" style={{ color: "var(--teal)" }}>
              If you believe this is an error or would like to discuss this matter, please contact us at{" "}
              <a href="mailto:info@mrcpiobgynunlocked.com" className="font-semibold underline">
                info@mrcpiobgynunlocked.com
              </a>
            </p>
          </div>
