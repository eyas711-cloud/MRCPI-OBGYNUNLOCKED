    ...
    <footer style={{ backgroundColor: "var(--navy)" }} className="text-white/70">
      <div className="max-w-7xl mx-auto px-6 pt-16 pb-8">
        ...
        <div className="pt-6 flex flex-col items-center gap-3">
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <div style={{ backgroundColor: "white", borderRadius: "14px", padding: "8px 28px", display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/DIABSTUDIOS Logo.png" alt="Diab Studios" style={{ height: "110px", width: "auto", objectFit: "contain" }} />
          </div>
        </div>
      </div>
    </footer>
